...
**Current Phase:** Closed Beta (Android — submitted for Google Play review 2026-03-27)
**Target:** 80 users in 4 weeks (Western/English-speaking market)
**Platform:** Android-first (iOS deferred until product stabilizes)

| Week | Target | Status |
|------|--------|--------|
| W1 (3/27-4/2) | 15 users | **In progress** — Closed testing submitted, Reddit post ready |
| W2 (4/3-4/9) | 30 users | Planned — Reddit #2, curator outreach |
